...
public class MovieView extends JFrame {
    ...
    public void setTfAlur(String tfAlur) {
        this.tfAlur.setText(tfAlur);
    }

    public void setTfPenokohan(String tfPenokohan) {
        this.tfPenokohan.setText(tfPenokohan);
    }

    public void setTfAkting(String tfAkting) {
        this.tfAkting.setText(tfAkting);
    }
